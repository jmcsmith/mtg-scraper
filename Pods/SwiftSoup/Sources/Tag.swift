...
open class Tag: Hashable {
    ...
    public var hashValue: Int {
        ...
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_isBlock ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _formatAsBlock ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_formatAsBlock ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _canContainBlock ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_canContainBlock ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _canContainInline ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_canContainInline ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _empty ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_empty ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _selfClosing ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_selfClosing ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _preserveWhitespace ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_preserveWhitespace ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _formList ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_formList ? 1 : 0).0
        //result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _formSubmit ? 1 : 0).0
        result = 31.multipliedReportingOverflow(by: result).0.addingReportingOverflow(_formSubmit ? 1 : 0).0
        return result
    }
